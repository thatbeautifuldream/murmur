...
import { ChevronDownIcon, Tick02Icon, ChevronUpIcon, UnfoldMoreIcon } from "@hugeicons/core-free-icons"
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <HugeiconsIcon icon={UnfoldMoreIcon} className="-me-1 size-4.5 opacity-80 sm:size-4" />
